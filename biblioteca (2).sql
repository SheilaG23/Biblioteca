...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-11-2024 a las 21:43:22
...
--
ALTER TABLE `prestamos`
  MODIFY `ID_Prestramo` int(11) NOT NULL AUTO_INCREMENT;
